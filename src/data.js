export const storeProducts = [
  {
    ...
    chef: "Chef Hamza",
    info:
      "Ce plat d’origine arabe à base de viande est le plus souvent préparé pour les grandes fêtes la fête du mouton (Aïd el kebir). On le déguste généralement à l’agneau ou au mouton enroulé dans des petits morceaux de crépine de mouton fraîche et très fine. Accompagné de salades et de légumes variés.",
    inCart: false,
    count: 0,
    total: 0
  },
